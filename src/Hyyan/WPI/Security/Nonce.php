...
class Nonce
{
     ...
     */
    public static function field($action, $name = '_wpinonce', $referer = true, $echo = true)
    {
     ...
     */
    public static function verifyOrDie($action, $name = '_wpinonce', $method = 'POST')
    {
        $request = null;
     ...
     * @param string $action Action name used when creating nonce
     * @param string $name   Optional. Nonce field name. Default '_wpinonce'
     * @param bool   $die    Optional. Whether to die on failure. Default true
     * @return bool|int False if nonce invalid and $die is false,
     *                  1 if valid and generated 0-12 hours ago,
     *                  2 if valid and generated 12-24 hours ago
     */
    public static function verifyAjax($action, $name = '_wpinonce', $die = true)
    {
